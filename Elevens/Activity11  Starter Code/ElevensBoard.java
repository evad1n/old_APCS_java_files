...
public class ElevensBoard extends Board {
    ...
    public boolean playIfPossible() {
        replaceSelectedCards(playPairSum11IfPossible());
        replaceSelectedCards(playJQKIfPossible());
        return playPairSum11IfPossible() != null || playJQKIfPossible() != null;
    }
     ...
     */
    private List<Integer> playPairSum11IfPossible() {
        return findPairSum11(cardIndexes());
    }
     ...
     */
    private List<Integer> playJQKIfPossible() {
        return findJQK(cardIndexes());
    }
}
